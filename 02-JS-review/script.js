...
// const summary = `${title}, a ${pages}-page long book, was writting by ${author} and published in ${
...
// const summaryArrowFunction = `${title}, a ${pages}-page long book, was writting by ${author} and published in ${getYear(
//   publicationDate
// )}. The book has ${hasMovieAdaptation ? "" : "not"} been adapted as a movie`;
// summaryArrowFunction;
...
// //(you can write : const sorted = arr.toSorted((a,b) => a-b ) ) ?
